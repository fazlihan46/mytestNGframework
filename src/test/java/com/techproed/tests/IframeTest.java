...
public class IframeTest {
    ...
    public void iframeTest(){
        ...
        textBox.clear();
        textBox.sendKeys("Merhaba Dunya!");
        //text box altinda bulunan selenium "Elemental Selenium" textini konsolda yazdirin.
        driver.switchTo().parentFrame(); // parent iframe gelebilmek icin kullanilir
        //driver.switchTo().defaultContent();// parent frame gecis icin kullanilir.
        WebElement seleniumText=driver.findElement(By.linkText("Elemental Selenium"));
        System.out.println(seleniumText.getText());



//iframe en basa donmek icin defaultContent() kullalnilir.

        //iframe buraya gelmek icin parentIframe() kullanilir
